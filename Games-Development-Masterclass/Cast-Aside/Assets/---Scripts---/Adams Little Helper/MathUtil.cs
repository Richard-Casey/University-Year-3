...
public static class MathUtil
{
    ...
    /// <summary>
    /// Gets a point at time t on a parabola defined by two positions and a height
    /// </summary>
    /// <param name="start">Inital Point</param>
    /// <param name="end">Final Point</param>
    /// <param name="height">Height Of The Peak</param>
